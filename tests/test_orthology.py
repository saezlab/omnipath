...
class TestOrthologyConversion():
    def test_complex_genes(self):
        ...
        default = translate_column(df, column ='symbol',
                                   id_type='genesymbol',
                                   target_organism=10090,
                                   )
        assert all(default['symbol'] == ['Cd8a_Cd8b1', 'Il4'])
        
        to_many = translate_column(df, column ='symbol',
                                   id_type='genesymbol',
                                   target_organism=10090, 
                                   replace=True, 
        ...
        keep_missing = translate_column(df, column ='symbol', 
                                        id_type='genesymbol',
                                        target_organism=10090,
                                        replace=False, 
        ...
        assert keep_missing[untranslated]['orthology_target'].isna().all() == True
